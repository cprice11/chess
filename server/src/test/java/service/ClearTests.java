...
public class ClearTests extends UnitTests{
    ...
    public void confirmDbCleared() {
        Assertions.assertEquals(authA, authDAO.getAuth(authA.username()));
        Assertions.assertEquals(authB, authDAO.getAuth(authB.username()));
        ...
        Assertions.assertNotNull(authDAO.getAuth(authA.username()));
        Assertions.assertNotNull(authDAO.getAuth(authA.username()));
        ...
        dev.clear();
        Assertions.assertNull(authDAO.getAuth(authA.username()));
        Assertions.assertNull(authDAO.getAuth(authA.username()));
